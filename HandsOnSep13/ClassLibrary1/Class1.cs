...
namespace ClassLibrary1
{
    ...
    public class User : Movie
    {
        ...
        {
            Movie m = new Movie("Game of Thrones", "English", "History", 200);
            dbmovies.Add(m);
            Movie k = new Movie("Hulk", "English", "Action", 250);
            dbmovies.Add(k);
            Movie t = new Movie("Goblin", "Korean", "Drama", 300);
            dbmovies.Add(t);
        ...
        public List<Movie> adding(List<Movie> rented1, string Type1)
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine("sorry the one u searched is not available");
                    return rented1;
                }
