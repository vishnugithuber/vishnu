...
namespace ClassLibrary1
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Midnight runners", "Korean", "Action", 200));
            movies.Add(new Movie("sky castle", "Korean", "Thriller", 250));
            movies.Add(new Movie("Godavari", "Telugu", "Fellgood", 300));
